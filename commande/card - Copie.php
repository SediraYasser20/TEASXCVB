...
if ($action == 'create' && $usercancreate) {
    ...
    if (empty($reshook)) {
        ...
        // Set to shipped (Classify Delivered, Restricted to admin)
        if (($object->statut == Commande::STATUS_VALIDATED || $object->statut == Commande::STATUS_SHIPMENTONPROCESS) && $usercanclose && $user->admin) {
