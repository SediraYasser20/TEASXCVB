...
/**
 *       \file       htdocs/cccccs/ajax/xxxxx.php
 *       \brief      File to return Ajax response on xxxxx list request
 */
...
// Security check
if (!$user->hasRight('cccccs', 'xxxxx', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax cccccs/ajax/xxxxx.php");
