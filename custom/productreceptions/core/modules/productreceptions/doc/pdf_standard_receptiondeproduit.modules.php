...
/**
 *  \file       core/modules/productreceptions/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_receptiondeproduit
 */
class pdf_standard_receptiondeproduit extends ModelePDFReceptiondeproduit
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Receptiondeproduit	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('PRODUCTRECEPTIONS_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PRODUCTRECEPTIONS_DRAFT_WATERMARK')));
		}
