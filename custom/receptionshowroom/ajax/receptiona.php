...
/**
 *       \file       htdocs/receptionshowroom/ajax/receptiona.php
 *       \brief      File to return Ajax response on receptiona list request
 */
...
// Security check
if (!$user->hasRight('receptionshowroom', 'receptiona', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax receptionshowroom/ajax/receptiona.php");
