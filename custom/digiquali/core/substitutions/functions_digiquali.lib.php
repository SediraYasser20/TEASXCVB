...
{
    // Fix: Only set substitution if $object is a valid object with element and ref properties
    if (is_object($object) && property_exists($object, 'element') && property_exists($object, 'ref')) {
