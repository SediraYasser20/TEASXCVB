...
/**
 *       \file       htdocs/recshow/ajax/receptionshowroom1.php
 *       \brief      File to return Ajax response on receptionshowroom1 list request
 */
...
// Security check
if (!$user->hasRight('recshow', 'receptionshowroom1', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax recshow/ajax/receptionshowroom1.php");
