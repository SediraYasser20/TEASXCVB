...
/**
 *       \file       htdocs/recshow/ajax/receptionshowroom.php
 *       \brief      File to return Ajax response on receptionshowroom list request
 */
...
dol_include_once('/recshow/class/receptionshowroom.class.php');
...
$object = new RECEPTIONSHOWROOM($db);

// Security check
if (!$user->hasRight('recshow', 'receptionshowroom', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax recshow/ajax/receptionshowroom.php");
