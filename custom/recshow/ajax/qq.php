...
/**
 *       \file       htdocs/recshow/ajax/qq.php
 *       \brief      File to return Ajax response on qq list request
 */
...
dol_include_once('/recshow/class/qq.class.php');
...
// Security check
if (!$user->hasRight('recshow', 'qq', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax recshow/ajax/qq.php");
