...
/**
 *       \file       htdocs/recshow/ajax/reception.php
 *       \brief      File to return Ajax response on reception list request
 */
...
dol_include_once('/recshow/class/reception.class.php');
...
// Security check
if (!$user->hasRight('recshow', 'reception', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax recshow/ajax/reception.php");
