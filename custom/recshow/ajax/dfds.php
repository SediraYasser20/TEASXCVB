...
/**
 *       \file       htdocs/recshow/ajax/dfds.php
 *       \brief      File to return Ajax response on dfds list request
 */
...
dol_include_once('/recshow/class/dfds.class.php');
...
// Security check
if (!$user->hasRight('recshow', 'dfds', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax recshow/ajax/dfds.php");
