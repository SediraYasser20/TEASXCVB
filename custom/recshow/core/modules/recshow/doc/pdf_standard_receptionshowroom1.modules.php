...
/**
 *  \file       core/modules/recshow/doc/pdf_standard.modules.php
 *  \ingroup    recshow
...
/**
 *	Class to manage PDF template standard_receptionshowroom1
 */
class pdf_standard_receptionshowroom1 extends ModelePDFReceptionshowroom1
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Receptionshowroom1	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('RECSHOW_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('RECSHOW_DRAFT_WATERMARK')));
		}
